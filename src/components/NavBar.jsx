...
function NavBar(prop) {
    ...
    return (
        <>
          <div className="absolute h-50 top-0 left-0 w-full z-40 bg-gradient-to-b from-white/60 via-white/20 to-transparent"></div>
            <nav className="absolute bg-white/0.1    z-50 w-full text-para flex justify-between px-5 py-3 lg:px-10 lg:py-2">
                ...
                <div className="hidden lg:flex lg:w-3/5 lg:px-20 lg:justify-between lg:items-center">
                    <ul className="w-full lg:w-4/5 lg:mx-auto font-semibold flex gap-4 flex-row pl-0 justify-between" id="nav-links">
                        <li className={prop.page === "home" ? "text-secondary" : "text-white hover:text-secondary"}>
                            <Link to="/">Home</Link>
                        </li>
                        <li className={prop.page === "about" ? "text-secondary" : "text-white hover:text-secondary"}>
                            <Link to="/aboutus">About</Link>
                        </li>

                        {/* destinations  */}
                        <li className="group hidden lg:block">
                            <span className={prop.page === "destination" ? "text-secondary flex items-center" : "text-white hover:text-secondary flex items-center"}>
                                Destination <IoIosArrowDown className="ml-1 group-hover:rotate-180 transition" />
                            </span>

                            {/* Dropdown Menu */}
                            <ul className="absolute w-full flex px-50 justify-center top-13 left-0 hidden group-hover:flex flex-row z-50 bg-white text-sm shadow-xl rounded-lg py-6 px-8 gap-10 ">
                        ...
                        <li className={prop.page === "career" ? "text-secondary" : "text-white hover:text-secondary"}>
                            <Link to="/career">Careers</Link>
                        </li>
                        <li className={prop.page === "contact" ? "text-secondary" : "text-white hover:text-secondary"}>
